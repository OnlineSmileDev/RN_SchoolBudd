                  ...
                  this.state.isQuestionModalVisible == true ? (
                    <Modal
                      ...
                      <View style={styles.modalViewQuestion}>
                        ...
                        />
                        <TouchableOpacity  onPress={() => this.onPressTopic()} style = {styles.selectBtn}>
                          <Text style = {styles.selectBtnTxt}>{this.state.currentTopic}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity  onPress={() => this.onPressPostQuestion()} style = {styles.selectBtn}>
                          <Text style = {styles.selectBtnTxt}>Post</Text>
                        </TouchableOpacity>
                      </View>
                    </Modal>
                  ) : (
